                    ...
                    >
                        ...
                        <ul>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="{{route('logout')}}" @click="open = false" @focus="open = true" @focusout="open = false" onclick="event.preventDefault();
